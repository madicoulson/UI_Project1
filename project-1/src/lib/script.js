...
export let dataPool = [
  {date:'09/03/2024', workout: {type:"Running", distance:3, duration:30}, water:1000, steps:8976},
  {date:'09/04/2024', workout: {"type":"Weight Lifting","duration":60,"lift":[{"exercise":"Bench Press","sets":4,"weight":75},
...
export function daysSinceStart() {
  ...
  // Get the start date. Get the current date.
  let startDate = new Date(dataPool[0].date);
  ...
  // Update the writable dataDifference variable with the number of days.
